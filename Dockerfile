...
RUN /usr/local/bin/install-plugins.sh maven-plugin docker-plugin docker-slaves build-pipeline-plugin config-file-provider console-column-plugin copy-to-slave extra-columns favorite cloudbees-folder git htmlpublisher javadoc workflow-aggregator
